 ...
 */
package de.cubeisland.engine.module.test;
...
import de.cubeisland.engine.module.test.tests.UtilTest;
...
{
    private Map<String, de.cubeisland.engine.module.test.tests.Test> tests;
    private Timer timer;
    ...
    public void onLoad()
    {
        ...
        for (Entry<String, de.cubeisland.engine.module.test.tests.Test> test : this.tests.entrySet())
        {
            try
            {
    ...
    public void registerTest(String name, de.cubeisland.engine.module.test.tests.Test test)
    {
