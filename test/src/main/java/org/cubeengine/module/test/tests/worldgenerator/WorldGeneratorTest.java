 ...
 */
package org.cubeengine.module.test.tests.worldgenerator;

import java.io.IOException;
import org.cubeengine.module.test.tests.Test;
...
public class WorldGeneratorTest extends Test
{
    ...
    public WorldGeneratorTest(org.cubeengine.module.test.Test module)
    {
        this.module = module;
    }
