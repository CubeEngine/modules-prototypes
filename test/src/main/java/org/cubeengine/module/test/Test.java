 ...
 */
package org.cubeengine.module.test;
...
import org.cubeengine.module.test.tests.AsyncCommandTest;
import org.cubeengine.module.test.tests.ClearChatTest;
import org.cubeengine.module.test.tests.DatabaseTest;
import org.cubeengine.module.test.tests.MatchTest;
import org.cubeengine.module.test.tests.ModuleTest;
import org.cubeengine.module.test.tests.UtilTest;
import org.cubeengine.module.test.tests.l18n.l18nTest;
import org.cubeengine.module.test.tests.listener.ListenerTest;
import org.cubeengine.module.test.tests.worldgenerator.WorldGeneratorTest;
...
{
    private Map<String, org.cubeengine.module.test.tests.Test> tests;
    private Timer timer;
    ...
    public void onLoad()
    {
        ...
        for (Entry<String, org.cubeengine.module.test.tests.Test> test : this.tests.entrySet())
        {
            try
            {
    ...
    public void registerTest(String name, org.cubeengine.module.test.tests.Test test)
    {
